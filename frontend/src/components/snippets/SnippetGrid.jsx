...
function SnippetGridItem({ snippet, onDetail, onEdit, onDelete }) {
  ...
  return (
    <div className="rounded-2xl border border-(--app-border) bg-(--app-alt) p-4 space-y-3 hover:border-(--app-accent) transition flex flex-col">
      ...
      {snippet.description && (
        <p className="text-xs text-(--app-text-dim) line-clamp-2">
          {snippet.description}
        </p>
      )}
