    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-(--app-text-dim) mt-1">{filtered.length} publikus snippet</p>
        </div>
      ...
      <div className="rounded-2xl border border-(--app-border) bg-(--app-alt) p-4">
        <div className="flex gap-3 flex-wrap items-start">
          ...
          <div className="relative">
            ...
            {tagDropdownOpen && (
              <div className="absolute z-10 mt-1 w-full min-w-48 rounded-xl border border-(--app-border) bg-(--app-alt) overflow-hidden"
