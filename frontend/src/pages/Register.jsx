    ...
    <div className="flex items-center justify-center min-h-[80vh]">
      <div className="w-full max-w-md rounded-3xl border border-(--app-border) bg-(--app-alt) p-8 space-y-6">
        <div>
          ...
          <p className="text-sm text-(--app-text-dim) mt-1">Hozd létre a fiókodat</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex gap-3">
            <div className="flex-1 space-y-1">
              <label className="text-xs text-(--app-text-dim)">Keresztnév</label>
              <input
                name="first_name"
            ...
            <div className="flex-1 space-y-1">
              <label className="text-xs text-(--app-text-dim)">Vezetéknév</label>
              <input
                name="last_name"
          ...
          <div className="space-y-1">
            <label className="text-xs text-(--app-text-dim)">Felhasználónév</label>
            <input
              name="username"
              value={form.username}
              onChange={handleChange}
